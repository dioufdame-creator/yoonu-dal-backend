        ...
        <>
          ...
          <div className="fixed bottom-20 left-3 right-3 z-50 lg:hidden animate-slide-up">
            <div className="bg-white rounded-3xl shadow-2xl p-4 space-y-3">
              ...
              {/* Section "Créer" (Dette/Tontine/Objectif) temporairement
                  masquée — on teste d'abord si Dépense/Revenu/Épargner
                  seuls suffisent aux utilisateurs. handleCreateShortcut
                  reste défini plus haut pour réactivation facile. */}
            </div>
          </div>
        </>
      )}
