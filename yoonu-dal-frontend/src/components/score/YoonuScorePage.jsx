...
// ==========================================
// YOONU SCORE PAGE V2 - BYPASS VERSION
// Force diagnostic completed if score exists
// ==========================================

const YoonuScorePageV2Bypass = ({ toast, onNavigate }) => {
  const [score, setScore] = useState(null);
  const [history, setHistory] = useState([]);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    console.log('=== SCORE PAGE BYPASS VERSION ===');
    loadData();
  }, []);
  ...
  // ✅ FIX TEMPORAIRE: Si pas de score, montrer le CTA
  if (!score) {
    return (
...
export default YoonuScorePageV2Bypass;